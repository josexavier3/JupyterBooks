...
<link rel="preload" as="script" href="../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv-jb/lib64/python3.13/site-packages/sphinx_togglebutton/translations/README';</script>
    <link rel="canonical" href="https://userweb.fct.unl.pt/~jmc.xavier/.venv-jb/lib64/python3.13/site-packages/sphinx_togglebutton/translations/README.html" />
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../_sources/.venv-jb/lib64/python3.13/site-packages/sphinx_togglebutton/translations/README.md" target="_blank"
...
<p>To convert to locale files run <code class="docutils literal notranslate"><span class="pre">_convert.py</span></code> in this folder.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv-jb/lib64/python3.13/site-packages/sphinx_togglebutton/translations"
        },
