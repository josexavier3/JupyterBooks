...
<html lang="pt" data-content_root="../../../../../../" >
  ...
  <head>
    ...
    <title>Markdown Files &#8212; Resolução de Problemas</title>
...
<link rel="preload" as="script" href="../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv-jb/lib64/python3.13/site-packages/jupyter_book/book_template/markdown';</script>
    <link rel="canonical" href="https://userweb.fct.unl.pt/~jmc.xavier/.venv-jb/lib64/python3.13/site-packages/jupyter_book/book_template/markdown.html" />
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../_sources/.venv-jb/lib64/python3.13/site-packages/jupyter_book/book_template/markdown.md" target="_blank"
